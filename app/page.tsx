...
const features = [
  {
    ...
    description:
      'Llama 3.3 70B analyzes your experience and the job description to craft a perfectly tailored CV.',
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    description:
      'Your CV is automatically emailed so you always have a copy, even on mobile.',
  },
  {
    icon: Shield,
...
const steps = [
  ...
  {
    step: '02',
    title: 'Choose a template & pay GH₵10',
    description:
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-white">
        {/* Background gradients — soft teal + warm gold */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_#f0fdfa_0%,_transparent_60%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,_#fffbeb_0%,_transparent_60%)]" />
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-28 text-center">
          ...
          <p className="max-w-2xl mx-auto text-xl text-slate-500 leading-relaxed mb-10">
            ...
            written, ATS-optimized CV PDF — tailored specifically to the role
          ...
          <div className="mt-16 grid grid-cols-3 gap-4 max-w-xl mx-auto">
            {[
              ...
              { value: 'GH₵10', label: 'Flat price, no sub' },
            ].map((stat) => (
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-8 relative">
            {/* connector lines */}
            <div className="hidden sm:block absolute top-10 left-[33%] right-[33%] h-px bg-gradient-to-r from-brand-200 to-gold-200" />
            {steps.map((s) => (
              <div key={s.step} className="relative text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-brand-500 to-gold-400 text-white rounded-2xl flex items-center justify-center mx-auto mb-6 text-2xl font-extrabold shadow-lg shadow-brand-100">
                  {s.step}
                </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-lg mx-auto px-4 text-center">
          ...
          <p className="text-slate-500 mb-12">Pay only when you need a CV. No recurring charges.</p>

          <div className="bg-white border-2 border-brand-200 rounded-3xl p-8 shadow-xl shadow-brand-50 relative">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2">
              <span className="bg-gradient-to-r from-brand-600 to-gold-500 text-white text-xs font-bold px-4 py-1.5 rounded-full tracking-wide uppercase shadow">
                One-Time Payment
              </span>
            </div>

            <div className="flex items-end justify-center gap-1 mt-2 mb-1">
              <span className="text-3xl font-bold text-slate-400 mb-2">GH₵</span>
              <span className="text-8xl font-extrabold text-slate-900 leading-none tracking-tighter">
                10
              </span>
            </div>
            <p className="text-slate-400 mb-8 text-sm">per CV · pay as you go</p>
      ...
      {/* ── CTA ─────────────────────────────────────────────────────── */}
      <section className="py-24 bg-gradient-to-br from-brand-600 to-gold-500 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-brand-100 text-lg mb-10">
            Join Ghanaian professionals using cvMaxGhana to land their dream roles.
          </p>
          <Link
            href="/login"
      ...
      <footer className="py-10 bg-slate-900">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-slate-400 text-sm flex items-center gap-1.5">
            ...
            CVs delivered in under 60 seconds
          </p>
          <p className="text-slate-600 text-xs">© 2025 cvMaxGhana. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
